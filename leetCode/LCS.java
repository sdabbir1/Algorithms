...
public class LCS {
	...
	public static void main(String [] args) throws IOException {
    	System.out.println("LCS = "+lcsrec("ATCTGTAACTG","CGCTACCG"));
    	System.out.println("LCS = "+lcsrec2("ATCTGTAACTG","CGCTACCG"));
    	System.out.println("LCS = "+lcsdyn("CGCTACCG","ATCTGTAACTG"));
  	}
